...
export function SchedulePolicy({ onNavigate }: SchedulePolicyProps) {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-gray-900 mb-2">스케줄 정책 설정</h1>
        <p className="text-gray-500">자동 스케줄링 제약조건 및 규칙 관리</p>
      </div>
